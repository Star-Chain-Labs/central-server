...
// ✅ CHANGE: Purane syncOdds aur syncCricketFancyBookmaker hata ke
//            naye fixed versions import karo
...
export const syncSports = async () => {
  try {
    ...
    console.error("❌ [Sports Sync] FATAL ERROR:", err.message);
  }
};
...
export const startSyncJobs = () => {
  ...
  // ✅ SAME setInterval — lock guard andar hai, pileup nahi hoga
  setInterval(syncOdds, 1000);
  setInterval(syncCricketFancyBookmaker, 1000);
